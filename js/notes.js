...
$(".youtubeLink").hover(
    ...
    function () {
      $(this).html('<small class="text-body-secondary youtubeLink"><img src="../images/youtube.png" alt="" style="height: 30px;"></small>')
    }
  );
...
function myFunction() {
    ...
    if (initialLoad) {
        // Hide all list items on initial load
    ...
    if (filter === "") {
        // Hide all list items if the search input is empty
        for (i = 0; i < li.length; i++) {
            li[i].style.display = "none";
        }
        return;
